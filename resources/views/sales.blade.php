          ...
          <div class="card-body">
            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
              ...
              <tr>
                ...
                <td>{{ $showlist->mode}}</td>
                <td>{{ $showlist->grandtotal}}</td>
                <td>
                    <a target="_blank" href="{{ url('generate-pdf') }}/{{ $showlist->invoiceno}}"><i class='bx bxs-printer'></i></a> &nbsp;
                    <a target="_blank" href=""><i class='bx bxs-share bx-flip-horizontal' ></i></a>
                </td>
